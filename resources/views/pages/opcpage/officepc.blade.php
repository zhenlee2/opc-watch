                                                    ...
                                                    <div class="dt-ext table-responsive">
                                                        <table class="display table-xs" id="export-button">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                    <a href="{{route('showpc', ['year' => '2022', 'semester' => '2'])}}" class="btn btn-light btn-sm example-popover form-control " data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View"><span class="icofont icofont-eye-alt" ></span></a>
