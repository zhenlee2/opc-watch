					...
					<div class="stepwizard">
						<div class="stepwizard-row setup-panel">
							<div class="stepwizard-step">
								<a class="btn btn-primary fa fa-user" href="#step-1"></a>
								<p>Registration</p>
							</div>
							<div class="stepwizard-step">
								<a class="btn btn-light fa fa-users" href="#step-2"></a>
								<p>Client-Focused</p>
							</div>
							<div class="stepwizard-step">
								<a class="btn btn-light fa fa-building-o" href="#step-3"></a>
								<p>Organization-Focused</p>
							</div>
							<div class="stepwizard-step">
								<a class="btn btn-light fa-solid fa-diagram-project" href="#step-4"></a>
								<p>GAD-APP</p>
							</div>
						</div>
					</div>
