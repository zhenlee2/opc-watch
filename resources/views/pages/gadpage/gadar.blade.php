	...
	<div class="col-sm-12">
		<div class="card">
				<ul class="nav nav-tabs" id="icon-tab" role="tablist">
					<li class="nav-item"><a class="nav-link active" id="icon-home-tab" data-bs-toggle="tab" href="#icon-home" role="tab" aria-controls="icon-home" aria-selected="true"><i class="icofont icofont-list"></i>Accomplishment Report List</a></li>
					<li class="nav-item"><a class="nav-link" id="profile-icon-tab" data-bs-toggle="tab" href="#profile-icon" role="tab" aria-controls="profile-icon" aria-selected="false"><i class="icofont icofont-ui-add"></i>Input Accomplishment Report</a></li>
										...
										<div class="stepwizard">
											<div class="stepwizard-row setup-panel">
												<div class="stepwizard-step">
													<a class="btn btn-primary" href="#step-1"><i class="fa fa-address-book-o" style="font-size:18px"></i></a>
													<p>Registration</p>
												</div>
												<div class="stepwizard-step">
													<a class="btn btn-light" href="#step-2"><i class="fa fa-users" aria-hidden="true" style='font-size:18px'></i></a>
													<p>Client-Focus</p>
												</div>
												<div class="stepwizard-step">
													<a class="btn btn-light" href="#step-3"><i class="fa fa-institution" style="font: size 18px"></i></a>
													<p>Organization-Focused</p>
												</div>
												<div class="stepwizard-step">
													<a class="btn btn-light" href="#step-4"><i class="fa fa-tasks" style="font: size 18px"></i></a>
													<p>GAD-APP</p>
												</div>
											</div>
										</div>
                     ...
                     <div class="email-app-sidebar left-bookmark">
                        <div class="media">
                           ...
                           <div class="media-body">
                              <h5 class="f-w-600">Gender Issue Or GAD Mandate</h5>
                              <!-- <p>Markjecno@gmail.com</p> -->
                           </div>
                        </div>
                        <ul class="nav main-menu contact-options" role="tablist">
                           <li class="nav-item">
                              <!-- <button class="badge-light-primary btn-block btn-mail w-100" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="me-2" data-feather="users"></i> New Contacts</button> -->
                           ...
                           <li><a id="pills-personal-tab" data-bs-toggle="pill" href="#pills-personal" role="tab" aria-controls="pills-personal" aria-selected="true">
                              <!-- <span class="title"> -->
                              <div class="media">
                                 ...
                                 <div class="media-body">
                                    ...
                                    <p class="email_add_0">WEDC shall be provided with services and interventions as necessary such as, but not limited to, the following: (a) Temporary and protective custody; (b) Medical and dental services; (c) Psychological evaluation; (d) Counseling; (e) Psychiatric evaluation; (f) Legal services; (g) Productivity skills capability building; (h) Livelihood assistance; (i) Job placement; (j) Financial assistance; and (k) Transportation assistance.</p>
                                 </div>
                              </div>   
                              <!-- </span> -->
                              </a></li>
                           ...
                           <li>
                              <a href="#">
                                 ...
                                 <!-- <div class="media-body"> -->
                                    <!-- <h6> <span class="first_name_0">Bucky </span><span class="last_name_0">Barnes</span></h6> -->
                                    <p class="email_add_0">RA 9710, Section 34 Services and Interventions for WEDC A. WEDC and their families shall be provided with services and interventions as necessary such as, but not limited to, the following: (a) temporary and protective custody, (b) medical and dental services, (c) psychological and psychiatric evaluation, (d) counseling and Critical Incident Stress Debriefing (CISD), (e) legal services, (f) productivity skills, capability building, and/or livelihood assistance, (g) education, (h) job placement, (i) financial assistance, and (j) transportation assistance. All service providers shall undergo capacity building to ensure gender-responsive, rights-based and culture-sensitive provision of services.</p>
                                 <!-- </div> -->
                              <!-- </div> -->
                              </a>
                           </li>
                                       ...
                                       <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                          <a class="contact-tab-0 nav-link active" id="v-pills-user-tab" data-bs-toggle="pill" onclick="activeDiv(0)" href="#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true">
                                             <div class="media">
                                                ...
                                                <div class="media-body">
                                                   <!-- <h6> <span class="first_name_0">Bucky </span><span class="last_name_0">Barnes</span></h6> -->
                                                   <p class="email_add_0">Number of families of gender-based violence victim-survivors provided with counseling services</p>
                                                </div>
                                             </div>
                                          </a>
                                          <a class="contact-tab-1 nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" onclick="activeDiv(1)" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                                             <div class="media">
                                                ...
                                                <div class="media-body">
                                                   ...
                                                   <p class="email_add_1">Number of families of gender-based violence victim-survivors provided with legal assistance</p>
                                                </div>
                                             </div>
                                          </a>
                                          ...
                                          <a class="contact-tab-5 nav-link" id="v-pills-contact8-tab" data-bs-toggle="pill" onclick="activeDiv(5)" href="#v-pills-contact2" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                             <div class="media">
                                          ...
                                          <a class="contact-tab-6 nav-link" id="v-pills-contact3-tab" data-bs-toggle="pill" onclick="activeDiv(6)" href="#v-pills-contact3" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                             <div class="media">
                                    ...
                                    <div class="col-xl-8 xl-50 col-md-7">
                                       ...
                                       <div class="contact-editform ps-0">
                                          <form>
                                             ...
                                             <a class="ps-0 edit-information" href="#">Edit more information</a>
                                             ...
                                             <div class="profile-mail">
                                                <div class="media">
                                                   ...
                                                   <div class="media-body mt-0">
                                                      ...
                                                      <ul>
                                                         {{-- <li><a href="#" onclick="printContact(8)" data-bs-toggle="modal" data-bs-target="">Print</a></li> --}}
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="email-general">
