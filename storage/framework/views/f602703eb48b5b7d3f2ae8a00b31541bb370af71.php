							...
							<div class="card o-hidden">
								...
								<div class="ecommerce-widgets media">
									...
									<p><h5>First Semester</h5></p>
										<h6 class="f-w-500 mb-0 f-26">No. of Indicator :  <span class="counter"><?php echo e($results); ?></span></h6>
									</div>
								...
								<div class="media">
									<div class="media-body">
										...
										<div class="progress-box">
											<h6 class="f-w-500 mb-0 f-26">No. of Indicator : <span class="counter"><?php echo e($results2); ?></span></h6>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cubastarterkit\resources\views/dashboard/dashboard-02.blade.php ENDPATH**/ ?>