...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/logo/DSWD-logo.png')); ?>" type="image/x-icon">
     <title>Welcome to DSWD Caraga OPC - Watch - <?php echo $__env->yieldContent('title'); ?></title>
    <!-- Google font-->
...
</html><?php /**PATH C:\laragon\www\cubastarterkit\resources\views/layouts/authentication/master.blade.php ENDPATH**/ ?>