                                                    ...
                                                    <div class="dt-ext table-responsive">
                                                        <table class="display table-xs" id="export-button">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <a href="#" onclick="editContact(0)" class="btn btn-light btn-sm example-popover form-control" href="#" onclick="editContact(0)" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View"> <span class="fa fa-ellipsis-v" ></span></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-xs">                
                                                <thead>
                                                    ...
                                                    <tr align="center" > 
                                                        <th scope="col" class="col-sm-3 col-form-label">Objectives, Program, Project, Activity</th>
                                                        <th scope="col" class="col-sm-1 col-form-label">Weight Allocation</th>                        
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
...
<script src="<?php echo e(asset('assets/js/typeahead-search/typeahead-custom.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cubastarterkit\resources\views/pages/office.blade.php ENDPATH**/ ?>