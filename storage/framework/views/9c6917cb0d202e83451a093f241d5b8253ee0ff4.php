      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="<?php echo e(route('auth.logout')); ?>"><i data-feather="log-in"> </i><span>Log out</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<?php /**PATH C:\laragon\www\cubastarterkit\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>