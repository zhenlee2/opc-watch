        ...
        <div class="col-sm-12">
			<div class="card">
					...
					<div class="tab-content" id="icon-tabContent">
                                            ...
                                            <!-- <div class="col-sm-12"> -->
                                                <!-- <div class="card"> -->
                                                    <!-- <div class="card-body"> -->
                                                        ...
                                                        <button class="btn btn-primary btn-sm update-contact btn-sm" data-bs-original-title="Cancel" type="button"><span class="icon-arrow-left"></span></button>
                                                            ...
                                                            <table class="table table-bordered table-xs">                
                                                                <thead>
                                                                    <tr align="center">
                                                                        ...
                                                                        <th rowspan="2" scope="col" class="col-sm-1 col-form-label"><button class="btn btn-primary btn-sm" type="button" data-bs-original-title="Add Performance Contract" data-bs-toggle="modal" data-bs-target="#updatePCModal"><span class="fa fa-plus-square-o"></span></button></th>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-xs">   
                                                <thead>
                                                    <tr id="final_rating">
                                                        <td colspan="5"></td>
                                                        <td name="total_weight"><button class="btn btn-success btn-sm save-final-rating pull-right form-control" data-bs-original-title="Save" type="button"><span class="icon-save"></span></button></td>
                                                        <!-- <td colspan="4"></td> -->
                                                    </tr>
                                                </thead>             
                                                <thead>
                                                    <tr align="center">
                                                        ...
                                                        <th rowspan="2" scope="col" class="col-sm-1 col-form-label">ALLOTTED BUDGET (in Php <i class="icofont icofont-cur-peso"></i>)</th>
                                                        <th rowspan="2" scope="col" class="col-sm-3 col-form-label">ACCOUNTABILITY CENTER </br> (<i class="icofont icofont-company"></i> Division, <i class="icofont icofont-unity-hand"></i> Units, <i class="icofont icofont-user-alt-4"></i> Individuals)</th>
                                                        <th rowspan="2" scope="col" class="col-sm-1 col-form-label"><button class="btn btn-primary btn-sm" type="button" data-bs-original-title="Add Performance Contract" data-bs-toggle="modal" data-bs-target="#createPCModal"><span class="fa fa-plus-square-o"></span></button></th>
                                                ...
                                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($d->indicator_id == 1): ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($d->sub_weight_allocation); ?></td>
                                                            <td class="p-0"><div class="row">
                                                                <div class="col-1 text-center p-0"><?php echo e($d->sort); ?></div>
                                                            ...
                                                            <td><?php echo e($d->alloted_budget); ?></td>
                                                            <td><?php echo e($d->accountability_center); ?></td>
                                                            <td></td>
                                                        </tr>
                                                    <?php endif; ?>
                        ...
                        <div class="tab-pane fade" id="contact-icon" role="tabpanel" aria-labelledby="profile-icon-tab">
                            <div class="col-sm-12">
                                <div class="card-body">
                                    <div class="table-responsive">
                                            <table class="table table-bordered table-xs">   
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cubastarterkit\resources\views/pages/officepc.blade.php ENDPATH**/ ?>